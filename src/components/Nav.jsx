    ...
    <>
      <nav className="px-4 flex items-center justify-between">
        ...
        <div className="flex gap-8">
          <Button
            color="bg-[#A02279]"
            className="hidden md:block bg-[#A02279] w-full  text-white text-center rounded-lg px-4 py-2"
            onClick={onClick}
          >
            Connect Wallet
          </Button>

          <button className="lg:hidden" onClick={onClickMenuIcon}>
            <HiOutlineMenuAlt3 />
          </button>
        </div>
      </nav>
      ...
      {/* Mobile navigation */}
      <div
        className={`px-4 border lg:hidden flex flex-col items-center w-4/5 mx-auto bg-opacity-20 backdrop-blur-md 
      ${!menuClicked ? "hidden" : ""}`}
      >
        <NavLink
          className="w-full text-center py-2 border-b hover:bg-[#A02279] hover:text-white"
          to="/"
        >
          Home
        </NavLink>
        ...
        <NavLink className="w-full text-center py-2 border-b  hover:bg-[#A02279] hover:text-white">
          NFTs
        </NavLink>
        <NavLink className="w-full text-center py-2   hover:bg-[#A02279] hover:text-white">
          Commuity
        </NavLink>
        <Button
          color="bg-[#A02279]"
          className="bg-[#A02279] w-full md:hidden text-white text-center rounded-lg px-4 py-2"
          onClick={onClick}
        >
          Connect Wallet
        </Button>
      ...
      <Modal show={modalIsOpen} size="md" popup={true} onClose={onClick}>
        <Modal.Header>
          <div class=" px-6 rounded-t dark:border-gray-600">
